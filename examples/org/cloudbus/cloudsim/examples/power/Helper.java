...
public class Helper {
	...
	public static void printResults(
		...
		BwHelper.totalTransmisionEnergy /= (3600 * 1000);
		...
		if (outputInCsv) {
			...
			Log.printLine();
		    Log.printLine(String.format("Threshold: " + BwHelper.THRESHOLD));
